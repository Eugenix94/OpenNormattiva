...
def get_dataset_repo():
    ...
    if "lab" in space or "normattiva" in space or "opennormattiva" in space:
        return f"{dataset_owner}/normattiva-lab-data"
    # Fallback to the search dataset by default
    return f"{dataset_owner}/normattivavigente-data"
